...
void game1(){
  ...
  text("What is the value of x in this equation?  5 + x = 13", width/2 , height/2 -150);
  textSize(50);
  ...
  text("x=8", width/2 -200, height/2 + 50);
  textSize(50);
  
  text("x=18", width/2 +200, height/2 +50);
  textSize(50);
  
  
   text("x=7", width/2 -200, height/2 + 350);
  textSize(50);
  
  text("x=13", width/2 +200, height/2 +350);
  textSize(50);
...
void game2(){
  ...
  text("What is the value of w in teh equation 116 - w=95?", width/2 , height/2 -150);
  textSize(50);
...
void game5(){
  ...
  text("Which picture shows 90° of a circle?", width/2 , height/2 -150);
